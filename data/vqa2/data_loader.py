...
class VQA2Dataset(data.Dataset):
    def __init__(self, split_dic_path, vocab_path, image_size, image_crop_size, prop_thresh=0, pad_length=20, verbase=1,
                 ppl_num=100, split="train"):
    ...
    def __getitem__(self, item):
        ...
        return img, box_feats, box_info, visual_hint, question, answer
...
if __name__ == "__main__":
    ...
    for data in ds_loader:
        print("------------------")
        img, box_feats, box_info, visual_hint, question, answer = data
